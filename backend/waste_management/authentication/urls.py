...
from .views import UserSignupView, CompanySignupView, LoginView, AdminSignupView, LogoutView, ProfileView, UpdateProfileView, UserManagementListView, UserUpdateView, UserDeleteView,AddressViewSet
