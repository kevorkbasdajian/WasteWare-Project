...
SECRET_KEY = 'django-insecure-cw#9ejscj#(^oa6*=yhs()pyu9wf%n#-f7zzsq)$^$dk+mk=5j'
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # ← ADD THIS LINE (position 2)
...
# Database configuration for Docker/Railway
DATABASES = {
    'default': {
